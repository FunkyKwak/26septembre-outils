...
## Signataires et volontaires les plus proches de chaque mobilisation
Cet outil permet de lister les signataires et volontaires les plus proches de chaque ville avec une mobilisation.
- On lui donne à lire des fichiers CSV exportés du site [26septembre.org](https://26septembre.org/admin/export)
- Il génère en sortie un fichier avec la liste des signataires et volontaires, avec pour chacun la ville avec une mobilisation la plus proche de chez lui, avec la distance en kilomètres
...
Sur la page des exports du site [26septembre.org](https://26septembre.org/admin/export), télécharger le fichier des signataires, des volontaires et des villes recensées, en cochant bien toutes les cases.

![Export Signataires](docs/images/export_signataires.png)<br/>
![Export Villes](docs/images/export_volontaires_villes.png)

### Télécharger l'outil
Télécharger la dernière version du fichier `signataires_volontaires_proches.exe` dans les [releases](https://github.com/FunkyKwak/26septembre-outils/releases).
...
4. Cliquer sur "Trouver les signataires et volontaires les plus proches des villes sélectionées"

![UI Signataires les plus proches de chaque mobilisation](docs/images/ui_signataires_volontaires_proches.png)
